...
class DataStoreSpider(scrapy.Spider):
    name = "zara-spider"
    homeURL = "https://www.zara.com/"
    subcat_item = SubcategoryItem()
    custom_cookies={
                    'selectedRegion': 'pk',
                    'OptanonConsent': 'isGpcEnabled=0&datestamp=Tue+Apr+23+2024+08%3A32%3A21+GMT%2B0500+(Pakistan+Standard+Time)&version=202401.1.0&browserGpcFlag=0&isIABGlobal=false&hosts=&consentId=5c65d915-d86d-40c2-ad46-79afaa87a141&interactionCount=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0002%3A1%2CC0003%3A1%2CC0004%3A1&geolocation=PK%3BPB&AwaitingReconsent=false',
                    'ITXSESSIONID': '71fee5cda8aa57ee7427246d4bed66e1',
                    'IDROSTA' : '3b62cc5d62d1:1162f5e982fc1020570365ae8',
    ...
    def start_requests(self):
        ...
        for url in start_urls:
            ...
            yield scrapy.Request(url = "https://www.zara.com/", callback=self.parse, cookies=self.custom_cookies , meta={'item': item})
    ...
    # 
        ...
        # self.log(f'Saved HTML content to {filename}')
        # print("I am here")
        parentSelector = "div.navigation.navigation--left > div.navigation__tier-1-container > ul.navigation__tier-1 > li"
        for li in response.css(parentSelector):
            GenderURLendpoint=li.css("a::attr(href)").get()
...
# 
    ...
    def parse_individualitemdetails(self, response):
        ...
        if(LoadMoreButton):
            itemURL = self.homeURL + subitemURL 
            yield scrapy.Request(url= LoadMoreItemsURL, callback= self.parse_individualitemdetails, meta={'itemname': itemname, 'subcategoryname': subcategoryname, 'categoryname': cateButton})
        # # # itemnames_list = [] 
